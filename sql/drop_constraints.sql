...
ALTER TABLE gtfs_routes
    DROP CONSTRAINT gtfs_routes_feed_fkey;
ALTER TABLE gtfs_fare_attributes
    DROP CONSTRAINT gtfs_fare_attributes_fare_fkey;
ALTER TABLE gtfs_fare_rules
    DROP CONSTRAINT gtfs_fare_rules_service_feed_fkey ;
ALTER TABLE gtfs_trips
    DROP CONSTRAINT gtfs_trips_feed_fkey;
ALTER TABLE gtfs_stop_times
    DROP CONSTRAINT gtfs_stop_times_feed_fkey;
ALTER TABLE gtfs_frequencies
    DROP CONSTRAINT gtfs_frequencies_feed_fkey;
ALTER TABLE gtfs_service_combinations
    DROP CONSTRAINT gtfs_service_combo_feed_fkey;
ALTER TABLE gtfs_transfers
    DROP CONSTRAINT gtfs_transfers_feed_fkey;
